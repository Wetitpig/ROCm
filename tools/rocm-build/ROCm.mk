...
$(call adddep,omnitrace,hipcc hsa hip_on_rocclr rocm_smi_lib rocprofiler roctracer rocm-cmake)
$(call adddep,opencl_icd_loader,)
$(call adddep,opencl_on_rocclr,${ASAN_DEP} hsa comgr opencl_icd_loader)
$(call adddep,openmp_extras,thunk lightning devicelibs hsa rocprofiler-register)
...
$(call adddep,rocprofiler,${ASAN_DEP} hsa roctracer aqlprofile opencl_on_rocclr hip_on_rocclr comgr hipcc rocprofiler-register)
$(call adddep,rocr_debug_agent,${ASAN_DEP} hip_on_rocclr hsa dbgapi lightning rocprofiler-register hipcc)
...
$(call adddep,composable_kernel,lightning hipcc hip_on_rocclr rocm-cmake devicelibs thunk rocprofiler-register hsa comgr)
...
$(call adddep,hipcub,hip_on_rocclr rocprim lightning hipcc devicelibs thunk rocprofiler-register hsa comgr)
...
$(call adddep,hipsparse,hip_on_rocclr rocsparse lightning hipcc devicelibs thunk rocprofiler-register hsa comgr)
...
$(call adddep,rccl,hip_on_rocclr hsa lightning hipcc rocm_smi_lib hipify_clang devicelibs thunk rocprofiler-register comgr)
$(call adddep,rocalution,rocblas rocsparse rocrand lightning hipcc devicelibs thunk rocprofiler-register hsa comgr openmp_extras hip_on_rocclr rocprim)
$(call adddep,rocblas,hip_on_rocclr openmp_extras lightning hipcc devicelibs thunk rocprofiler-register hsa comgr)
...
$(call adddep,rocmvalidationsuite,hip_on_rocclr hsa rocblas rocm-core lightning hipcc rocm_smi_lib devicelibs thunk rocprofiler-register comgr openmp_extras)
$(call adddep,rocprim,hip_on_rocclr lightning hipcc devicelibs thunk rocprofiler-register hsa comgr)
$(call adddep,rocrand,hip_on_rocclr lightning hipcc devicelibs thunk rocprofiler-register hsa comgr)
$(call adddep,rocsolver,hip_on_rocclr rocblas rocsparse lightning hipcc)
$(call adddep,rocsparse,hip_on_rocclr rocprim lightning hipcc devicelibs thunk rocprofiler-register hsa comgr)
$(call adddep,rocthrust,hip_on_rocclr rocprim lightning hipcc devicelibs thunk rocprofiler-register hsa comgr)
...
# Pass in jobserver info using the RMAKE variable
	...
	then mv $$@.inprogress $$@ && cp $$@ $$@.repackaged; \
